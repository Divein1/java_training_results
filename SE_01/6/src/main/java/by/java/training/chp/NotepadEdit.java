...
public class NotepadEdit {
	...
	/**
	 * ќсуществл€ет проверку ввода, не принимает ничего кроме Int.
	 */
	 ...
	 * 
	 * @param strArray
	 *            обрабатываемый массив строк
	 */
	private void addNote(String[] strArray) {
		String str;
	...
	/**
	 * ќчищает строку. Ќормализует массив строк выкидыва€ из последовательности
	 * пустые.
	 * 
	 * @param strArray
	 *            обрабатываемый массив строк.
	 */
	private void removeNote(String[] strArray) {
		int n;
	...
	/**
	 * ќчищает строку, записывает в нее новое значение введенное пользователем.
	 * 
	 * @param strArray
	 *            обрабатываемый массив строк.
	 */
	private void editNote(String[] strArray) {
		String str;
	 ...
	 *            обрабатываемый массив строк.
	 */
	private void viewAll(String[] strArray) {
		for (int i = 0; i < strArray.length; i++) {
